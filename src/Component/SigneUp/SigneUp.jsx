...
export default function SigneUp() {
  ...
  return (
    <>
    <h1 className="text-center p-7">Register Now</h1>
    {
...
<form onSubmit={regiserForm.handleSubmit} className="w-7/12 mx-auto">
<div className="mb-5">
  ...
  {/* {regiserForm.touched.email && regiserForm.errors?<p className="text-gray-50 border">errrror</p>:""} */}
  <div className="mb-5">
  ...
  disabled={!(regiserForm.isValid && regiserForm.dirty)}
   type="submit" className="text-white bg-active  focus:ring-4 focus:outline-none focus:ring-active font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-active dark:hover:bg-active dark:focus:ring-active disabled:bg-active disabled: bg-opacity-35">Submit</button>
</form>
